<li class="nav-item">
          ...
          <li class="nav-item">
            <a href="{{route('laporan.instruktur')}}" class="nav-link {{ (request()->is('q/laporan/instruktur')) ? 'active' : '' }}">
              <i class="nav-icon fas fa-file-contract"></i>
              <p>Laporan Instruktur</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{route('laporan.peserta')}}" class="nav-link {{ (request()->is('q/laporan/peserta')) ? 'active' : '' }}">
              <i class="nav-icon fas fa-file-contract"></i>
              <p>Laporan Peserta Kursus</p>
            </a>
          </li>